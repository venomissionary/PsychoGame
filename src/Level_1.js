...
//functions and references 
        this.Player = new Player(this, this.cameras.main.centerX, this.cameras.main.centerY, this.cameras.main).setScale(1.5).setOrigin(8, 1).setDepth(2);
